...
SECRET_KEY = 'django-insecure-l8a6bym%07r!^zf@1f9!&9-ovkjy@u4o4%iomauxg=3m0@p0t2'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.category.category_list',
                'CartApp.cartCounter.cartCounterItem'
            ],
        },
    },
]
...
EMAIL_PORT=587
EMAIL_HOST_USER='amitsaini201295@gmail.com'
EMAIL_HOST_PASSWORD='rtrqariquvodbnnh'
EMAIL_USE_TLS=True
EMAIL_USE_SSL = False 
